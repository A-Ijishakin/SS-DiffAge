...
def CamCan_autoenc_base():
    conf = autoenc_base()
    conf.data_name = 'CamCan'  
...
if full:
    net_ch, net_ch_mult, net_enc_channel_mult = 128, (1, 1, 2, 3, 4), (1, 1, 2, 3, 4, 4) 
else: 
    net_ch, net_ch_mult, net_enc_channel_mult = 32, (1, 2, 3, 4), (1, 2, 3, 4)

def BrainAge_autoenc_base():
    conf = autoenc_base() 
...
def CamCan_autoenc_130M():
    conf = CamCan_autoenc_base() 
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'CamCan_autoenc_130M'
    return conf 

def BrainAge_autoenc_130M():
    conf = BrainAge_autoenc_base() 
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'BrainAge_autoenc_130M'
    return conf 



def NACC_autoenc_130M():
    conf = NACC_autoenc_base() 
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'NACC_autoenc_130M'
    return conf 


def OHBM_autoenc_130M():
    conf = OHBM_autoenc_base() 
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'OHBM_autoenc_130M'
    return conf 
