...
model_configuation = BrainAge_autoenc_130M()  

#set the url and output file name 
url, output_file = "https://zenodo.org/record/8383593/files/epoch%3D624-step%3D82024.ckpt?download=1", "Model_weights.ckpt"
...
state = torch.load(output_file, map_location='cuda') 
